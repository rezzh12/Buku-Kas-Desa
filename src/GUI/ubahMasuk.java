 ...
 * @author bayujp
 */
public class ubahMasuk extends javax.swing.JFrame {
String pinjam;
String balik;
    /**
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 430, -1, 30));
        ...
        jLabel3.setText("Ubah/Hapus Kas Masuk");
...
try{
  String query = "select * from kas_masuk where id_masuk = '"+tfId.getText()+"'";
...
new saldoMasuk().setVisible(true);
    ...
    try {
            String sql ="delete from kas_masuk where id_masuk='"+tfId.getText()+"'";
